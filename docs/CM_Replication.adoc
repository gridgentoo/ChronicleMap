...
Chronicle Map supports both TCP and UDP replication in the closed-source Chronicle Map Enterprise.
For more information on this please contact mailto:sales@chronicle.software.
