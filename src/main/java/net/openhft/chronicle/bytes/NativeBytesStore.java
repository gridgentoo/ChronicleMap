...
public class NativeBytesStore<Underlying>
    ...
    public Memory check(long offset) {
        if (offset > 45334 && offset < 45336)
            System.out.println("");
        return memory;
    }
    ...
    public NativeBytesStore<Underlying> zeroOut(long start, long end) {
        ...
        check(start).setMemory(address + translate(start), end - start, (byte) 0);
        return this;
    }
    ...
    public boolean compareAndSwapInt(long offset, int expected, int value) {
        return check(offset).compareAndSwapInt(address + translate(offset), expected, value);
    }

    @Override
    public void testAndSetInt(long offset, int expected, int value) {
        check(offset).testAndSetInt(address + translate(offset), offset, expected, value);
    }

    @Override
    @ForceInline
    public boolean compareAndSwapLong(long offset, long expected, long value) {
        return check(offset).compareAndSwapLong(address + translate(offset), expected, value);
    }

    @Override
    @ForceInline
    public long addAndGetLong(long offset, long adding) throws BufferUnderflowException {
        return check(offset).addLong(address + translate(offset), adding);
    }

    @Override
    @ForceInline
    public int addAndGetInt(long offset, int adding) throws BufferUnderflowException {
        return check(offset).addInt(address + translate(offset), adding);
    }
    ...
    public byte readByte(long offset) {
        ...
        return check(offset).readByte(address + translate(offset));
    }
    ...
    public short readShort(long offset) {
        return check(offset).readShort(address + translate(offset));
    }

    @Override
    @ForceInline
    public int readInt(long offset) {
        return check(offset).readInt(address + translate(offset));
    }
    ...
    public long readLong(long offset) {
        ...
        assert address != 0;
        return check(offset).readLong(address + translate(offset));
    }

    @Override
    @ForceInline
    public float readFloat(long offset) {
        return check(offset).readFloat(address + translate(offset));
    }

    @Override
    @ForceInline
    public double readDouble(long offset) {
        return check(offset).readDouble(address + translate(offset));
    }

    @Override
    @ForceInline
    public byte readVolatileByte(long offset) {
        return check(offset).readVolatileByte(address + translate(offset));
    }

    @Override
    @ForceInline
    public short readVolatileShort(long offset) {
        return check(offset).readVolatileShort(address + translate(offset));
    }

    @Override
    @ForceInline
    public int readVolatileInt(long offset) {
        return check(offset).readVolatileInt(address + translate(offset));
    }

    @Override
    @ForceInline
    public long readVolatileLong(long offset) {
        return check(offset).readVolatileLong(address + translate(offset));
    }
    ...
    public NativeBytesStore<Underlying> writeByte(long offset, byte i8) {
        check(offset).writeByte(address + translate(offset), i8);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeShort(long offset, short i16) {
        check(offset).writeShort(address + translate(offset), i16);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeInt(long offset, int i32) {
        check(offset).writeInt(address + translate(offset), i32);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeOrderedInt(long offset, int i) {
        check(offset).writeOrderedInt(address + translate(offset), i);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeLong(long offset, long i64) {
        check(offset).writeLong(address + translate(offset), i64);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeOrderedLong(long offset, long i) {
        check(offset).writeOrderedLong(address + translate(offset), i);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeFloat(long offset, float f) {
        check(offset).writeFloat(address + translate(offset), f);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeDouble(long offset, double d) {
        check(offset).writeDouble(address + translate(offset), d);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeVolatileByte(long offset, byte i8) {
        check(offset).writeVolatileByte(address + translate(offset), i8);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeVolatileShort(long offset, short i16) {
        check(offset).writeVolatileShort(address + translate(offset), i16);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeVolatileInt(long offset, int i32) {
        check(offset).writeVolatileInt(address + translate(offset), i32);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> writeVolatileLong(long offset, long i64) {
        check(offset).writeVolatileLong(address + translate(offset), i64);
        return this;
    }
    ...
    public NativeBytesStore<Underlying> write(
        ...
        check(offset).copyMemory(bytes, offset, address + translate(offsetInRDO), length);
        return this;
    }
    ...
    public void write(
        ...
        if (bytes.isDirect()) {
            check(offset).copyMemory(((DirectBuffer) bytes).address() + offset,
                    address + translate(offsetInRDO), length);

        } else {
            check(offset).copyMemory(bytes.array(), offset, address + translate(offsetInRDO), length);
        }
    }
    ...
    public void nativeRead(long position, long address, long size) throws BufferUnderflowException {
        ...
        check(address).copyMemory(addressForRead(position), address, size);
    }
    ...
    public void nativeWrite(long address, long position, long size) throws BufferOverflowException {
        // TODO add bounds checking.
        check(addressForWrite(position)).copyMemory(address, addressForWrite(position), size);
    }
    ...
    void write8bit(long position, char[] chars, int offset, int length) {
        ...
        for (int i = 0; i < length; i++)
            check(offset).writeByte(addr + i, (byte) chars[offset + i]);
    }
    ...
    public long readIncompleteLong(long offset) {
        ...
        for (int i = 0; i < remaining; i++) {
            byte b = check(offset).readByte(address + offset + i);
            l |= (long) (b & 0xFF) << (i * 8);
        }
        return l;
    }
    ...
    public long copyToDirect(@NotNull BytesStore store) {
        ...
        if (read > 0) {
            try {
                ...
                check(addr2).copyMemory(addr, addr2, read);
    ...
    public int byteCheckSum(long position, long limit) {
        ...
        for (; ptr < end - 7; ptr += 8) {
            b += check(offset).readByte(ptr)
                    + check(offset).readByte(ptr + 1)
                    + check(offset).readByte(ptr + 2)
                    + check(offset).readByte(ptr + 3)
                    + check(offset).readByte(ptr + 4)
                    + check(offset).readByte(ptr + 5)
                    + check(offset).readByte(ptr + 6)
                    + check(offset).readByte(ptr + 7);
        }
        for (; ptr < end; ptr++) {
            b += check(offset).readByte(ptr);
        }
    ...
    public long read(long offsetInRDI, byte[] bytes, int offset, int length) {
        ...
        for (i = 0; i < len - 7; i += 8)
            UnsafeMemory.UNSAFE.putLong(bytes, offset2 + i, check(offset).readLong(address + i));
        if (i < len - 3) {
            UnsafeMemory.UNSAFE.putInt(bytes, offset2 + i, check(offset).readInt(address + i));
            i += 4;
        }
        for (; i < len; i++)
            UnsafeMemory.UNSAFE.putByte(bytes, offset2 + i, check(offset).readByte(address + i));
        return len;
    }
...
//        last.writeVolatileByte(88, (byte) 1);
        int ret = translate >= maximumLimit ? -1 :
                check(offset).readByte(address2) & 0xFF;
