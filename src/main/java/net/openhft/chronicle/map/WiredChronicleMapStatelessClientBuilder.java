 ...
 * @author Rob Austin.
 */
public final class WiredChronicleMapStatelessClientBuilder<K, V> implements
        ChronicleHashStatelessClientBuilder<WiredChronicleMapStatelessClientBuilder<K, V>,
                ChronicleMap<K, V>>,
    ...
    @Override
    public WiredChronicleMapStatelessClientBuilder<K, V> putReturnsNull(boolean putReturnsNull) {
    ...
    @Override
    public WiredChronicleMapStatelessClientBuilder<K, V> removeReturnsNull(boolean removeReturnsNull) {
    ...
    @Override
    public WiredChronicleMapStatelessClientBuilder<K, V> timeout(long timeout, TimeUnit units) {
    ...
    @Override
    public WiredChronicleMapStatelessClientBuilder<K, V> name(String name) {
        this.name = name;
        return this;
    }
    ...
    @Override
    public WiredChronicleMapStatelessClientBuilder<K, V> tcpBufferSize(int tcpBufferSize) {
